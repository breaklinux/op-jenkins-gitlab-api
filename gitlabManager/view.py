...
gitMgUrl = Blueprint('git', __name__)

@gitMgUrl.route('/api/v1', methods=['GET', 'POST', 'DELETE', 'PUT'])
def gitlabRun():
    """
    1.查询app项目默认一页5条数据
    ...
    from gitlabManager.utils import fetch_versions
...
@gitMgUrl.route('/envlist/v1', methods=['GET', 'POST', 'DELETE', 'PUT'])
def envListRun():
    import json
    if request.method == "GET":
...
@gitMgUrl.route('/release/v1', methods=['GET', 'POST', 'DELETE', 'PUT'])
def releaseListRun():
    import json
    if request.method == "GET":
        instanceListEev = DeployParameter()
...
@gitMgUrl.route('/langlist/v1', methods=['GET', 'POST', 'DELETE', 'PUT'])
def languageListRun():
    import json
    if request.method == "GET":
        instanceListEev = DeployParameter()
...
@gitMgUrl.route('/searchpack/v1', methods=['GET', 'POST', 'DELETE', 'PUT'])
